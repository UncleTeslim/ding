  ...
  return (
    <div className={`logo-lockup ${size}`}>
      <svg className="logo-mark" viewBox="0 0 48 48" role="img" aria-label="Ding logo">
        ...
        />
        <path d="M21 36a3.5 3.5 0 0 0 6 0" fill="none" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" />
        <circle cx="34" cy="14" r="5" fill="#155eef" stroke="#ffffff" strokeWidth="2" />
      </svg>
      {showWordmark ? (
        <div>
